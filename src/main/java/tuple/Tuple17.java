...
/**
 * @author NicolasMahn
 * This class can store 17 different objects in one
 */
public class Tuple17<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q>  extends Tuple {
    ...
    public N fourteenth; public O fifteenth; public P sixteenth; public Q seventeenth;
    private final int LENGTH = 17;

    public Tuple17(A first, B second, C third, D fourth, E fifth, F sixth, G seventh, H eighth, I ninth, J tenth,
