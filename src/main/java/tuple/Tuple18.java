...
/**
 * @author NicolasMahn
 * This class can store 18 different objects in one
 */
public class Tuple18<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R>  extends Tuple {
    ...
    public Tuple18(A first, B second, C third, D fourth, E fifth, F sixth, G seventh, H eighth, I ninth, J tenth,
