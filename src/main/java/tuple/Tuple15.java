...
/**
 * @author NicolasMahn
 * This class can store 15 different objects in one
 */
public class Tuple15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>  extends Tuple {
    ...
    public N fourteenth; public O fifteenth;
    private final int LENGTH = 15;

    public Tuple15(A first, B second, C third, D fourth, E fifth, F sixth, G seventh, H eighth, I ninth, J tenth,
