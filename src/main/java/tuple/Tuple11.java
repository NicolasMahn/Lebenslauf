...
/**
 * @author NicolasMahn
 * This class can store 11 different objects in one
 */
public class Tuple11<A, B, C, D, E, F, G, H, I, J, K>  extends Tuple {
    public A first; public B second; public C third; public D fourth; public E fifth; public F sixth; public G seventh;
    public H eighth; public I ninth; public J tenth; public K eleventh;
    private final int LENGTH = 11;

    public Tuple11(A first, B second, C third, D fourth, E fifth, F sixth, G seventh, H eighth, I ninth, J tenth,
                   K eleventh) {
